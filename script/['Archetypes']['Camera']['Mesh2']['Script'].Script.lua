...
local canSee = true
--local r = 1  --哪个房间
Camera:Rotate(Vector3(0,1,0),-60)
...
local NPC = script.Parent.Parent.Parent.Parent.NPCs:GetChildren()
...
do 
	...
	angle = i
	Camera:Rotate(Vector3(0,1,0), flag)
	--Camera:Rotate(Vector3(0,1,0),angle)
	--print(i)
		if i == 0 then
			flag = 1 
		end
